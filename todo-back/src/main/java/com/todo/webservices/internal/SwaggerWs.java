package com.todo.webservices.internal;
...
import com.todo.services.configuration.ConfigurationService;
...
public class SwaggerWs {
	...
	public SwaggerWs(ConfigurationService configurationService) {
		...
		SwaggerConfiguration openApiConfig = new SwaggerConfiguration()
			.resourcePackages(Set.of("com.todo.webservices.api"))
			.sortOutput(true)
			.openAPI(new OpenAPI().servers(List.of(
				new Server()
					.url("/api")
					.description("API todo-back")
			)));
